...
export async function generateMetadata({
    ...
    const canonicalUrl = `${SITE_URL}/writings/columns/${slug}`;
...
function buildJsonLd(post: { meta: { title: string; date: string; description: string; slug: string }; content: string }) {
    return {
        ...
        url: `${SITE_URL}/writings/columns/${post.meta.slug}`,
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": `${SITE_URL}/writings/columns/${post.meta.slug}`,
        },
    };
}
...
export default async function ColumnDetailPage({
    ...
    // JSON-LD is server-generated from trusted local MDX files only
    return (
        <>
            <script
